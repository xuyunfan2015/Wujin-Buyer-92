    ...
    reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _avatarView = [[WTURLImageView alloc] initWithFrame:CGRectMake(10, 7, 45, 45)];
        _avatarView.layer.cornerRadius = 5;
        [_avatarView.layer masksToBounds];
...
-(void)layoutSubviews{
    ...
    [self.avatarView setURL:[self.imageURL absoluteString] defaultImage:TTImage(@"chatListCellHead.png")];
...
- (void) URLImageViewDidClicked : (WTURLImageView*)imageView {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(chatCellDidClickAvatarWithIndexRow:)]) {
        
        [self.delegate chatCellDidClickAvatarWithIndexRow:self.indexRow];
    }
}
