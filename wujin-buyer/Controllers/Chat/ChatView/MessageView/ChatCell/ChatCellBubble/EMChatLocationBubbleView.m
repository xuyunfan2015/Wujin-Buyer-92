...
//    CGSize addressSize = [self.model.address sizeWithFont:_addressLabel.font constrainedToSize:textBlockMinSize lineBreakMode:NSLineBreakByCharWrapping];
    ...
    CGSize addressSize = [self.model.address boundingRectWithSize:textBlockMinSize options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:_addressLabel.font} context:nil].size;
