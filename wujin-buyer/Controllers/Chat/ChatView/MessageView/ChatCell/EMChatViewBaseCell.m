...
- (id)initWithMessageModel:(MessageModel *)model reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    //    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(headImagePressed:)];
        _headImageView = [[WTURLImageView alloc] initWithFrame:CGRectMake(HEAD_PADDING, CELLPADDING, HEAD_SIZE, HEAD_SIZE)];
...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.headImageURL) {
        
        [self.headImageView setURL:[messageModel.headImageURL absoluteString] defaultImage:TTImage(@"chatListCellHead")];

        
    }else {
        
      
        [self.headImageView setURL:nil defaultImage:TTImage(@"chatListCellHead")];
