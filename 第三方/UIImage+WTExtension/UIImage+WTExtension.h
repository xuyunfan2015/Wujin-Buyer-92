...
typedef NS_ENUM(NSInteger, UIImageResizeFillType) {
    UIImageResizeFillTypeIgnoreAspectRatio = 0,//图片拉伸至填充整个空间
    UIImageResizeFillTypeFillIn = 1,//图片填满控件 并且不拉伸，切图
    UIImageResizeFillTypeFitIn = 2,////图片整张显示,不拉伸,

};

@interface UIImage (WTExtension)//条
